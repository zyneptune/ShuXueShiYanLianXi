...
% Last Modified by GUIDE v2.5 30-Mar-2018 16:59:23
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ts=get(handles.text2,'String');
if(~isempty(ts))
    ts(end)=[];
end
set(handles.text2,'String',ts);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if handles.isresult==1
    ts=get(handles.text2,'String');
    es=get(handles.edit1,'String');
    ts=strcat(es,ts);
    result=eval(ts);
    set(handles.edit1,'String',strcat(num2str(result),'/'));
    set(handles.text2,'String','');
    handles.isresult=0;
end
if handles.isresult==0
    es=get(handles.edit1,'String');
    es(end)='/';
    set(handles.edit1,'String',es);
end
handles.done=0;
guidata(hObject, handles);
